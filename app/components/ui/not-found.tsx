...
export default function NotFound() {
  return (
    <div className="bg-white w-full dark:bg-[#1a1d21] dark:text-white border-2 border-black rounded-2xl shadow-md flex flex-col items-center justify-center p-4">
