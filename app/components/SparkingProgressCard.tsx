            ...
            <p>
                {trading
                    ...
                    :   <>
                            ...
                            <Link href={'https://app.camelot.exchange/?token1=' + process.env.NEXT_PUBLIC_SRK_TOKEN + '&token2=' + contractAddress + '&swap=v2'} target="_blank" rel="noreferrer" className="text-sparkyOrange-600">Camelot</Link>
                            {`.`}
                        </>
                }
            </p>
